...
export default function FindDoctor() {
  ...
  useEffect(() => {
    async function fetchDoctors() {
      const { data } = await axios.get("http://154.38.186.138:5000/api/Doctors");
  ...
  return (
    <div className="container">
      <h1 className="text-center font-bold text-3xl m-5 text-primary pt-5">
        Find The <span className="text-secondary">Best Doctor</span>{" "}
      </h1>
