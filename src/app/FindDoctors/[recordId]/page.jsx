...
//             <div>
//               <img
//                 src={doctor.image || "/DR.png"}
//                 alt={doctor.name}
//                 className="rounded-lg w-80 h-full object-cover"
//               />
//             </div>
...
//               <BookAppointment doctorId={recordId} />
//             </div>
//           </div>
...
//                 <img
//                   src={suggestedDoctor.image || "/DR.png"}
//                   alt={suggestedDoctor.name}
//                   className="rounded-lg w-60 h-full object-cover"
//                 />
//                 <h3 className="font-bold text-xl pt-2 text-primary">DR. {suggestedDoctor.name}</h3>
//                 <h2 className="flex gap-2 text-secondary py-1">
//                   <Stethoscope />
//                   <span className="text-[18px] px-2 text-gray-800">
//                     {suggestedDoctor.speciality}
//                   </span>
//                 </h2>
//                 <h2 className="flex gap-2 text-secondary py-1">
//                   <MapPin />
...
import Image from "next/image";
import { MapPin, Phone, Stethoscope, CircleDollarSign, BookAIcon, Heart } from "lucide-react";
import React, { useEffect, useState } from "react";
import { Button } from "@/components/ui/button";
import Link from "next/link";
import BookAppointment from "../_component/BookAppointment";
...
export default function Details({ params }) {
  ...
  const toggleFavorite = () => {
    ...
    // Here you can also add logic to update the favorite status in the backend if necessary.
  };
            ...
            <div className="col-span-2 mt-6 flex flex-col gap-3 md:px-10 items-baseline">
              <div className="flex justify-between w-full items-center">
                ...
                <button onClick={toggleFavorite} className="focus:outline-none">
                  <Heart color={isFavorite ? "red" : "black"} filled={isFavorite ? "true" : "false"} />
                </button>
              </div>
              <h2 className="flex gap-2 text-2xl text-secondary">
                <MapPin />
