...
//   if (!doctor) {
//     return <div className=" gap-2 w-screen flex justify-center mx-auto p-96 ">
...
//       <h2 className='font-bold mt-10 text-4xl text-primary'>Details</h2>
...
//               /> */}
//               {/* <img src={doctor.image || '/default-image.jpg'} alt={doctor.name}  className='rounded-lg w-full h-[280px] object-cover'/> */}

//               <img src={ '/DR.png'} alt={doctor.name}  className='rounded-lg w-80 h-full object-cover '/>
...
//               </h2>
//               <Button className="mt-3 rounded-full text-white">Book Appointment</Button>
//             </div>
//           </div>
...
//                   width={100}
//                   height={100}
//                   alt='Suggested-Doctor-Image'
//                   className='rounded-lg w-full h-[100px] object-cover'
//                 /> */}
//                   {/* <img src={suggestedDoctor.image || '/default-image.jpg'} alt={suggestedDoctor.image}  className='rounded-lg w-full h-[100px] object-cover'/> */}

//                   <img src={ '/DR.png'} alt={suggestedDoctor.image}  className='rounded-lg w-60 h-full object-cover '/>


//                 <h3 className='font-bold text-xl pt-2 text-primary'>DR. {suggestedDoctor.name}</h3>
//                 {/* <p className=''>{suggestedDoctor.speciality}</p> */}
...
//                 {/* <p>{suggestedDoctor.address}</p> */}
//                 <Link href={`/FindDoctors/${suggestedDoctor.id}`}><Button className="mt-2 rounded-full text-white">View Profile</Button></Link>
//               </div>
//             ))}
//           </div>
//         </div>
      ...
      <div className='grid grid-cols-1 md:grid-cols-4'>
        ...
        <div className='col-span-1 pl-5'>
          ...
          <div className='suggested-doctors-container overflow-y-auto max-h-[80vh]'>
            {suggestedDoctors.map((suggestedDoctor) => (
              <div key={suggestedDoctor.id} className='border-[1px] p-3 rounded-lg'>
                <img src={'/DR.png'} alt={suggestedDoctor.name} className='rounded-lg w-60 h-full object-cover' />
                <h3 className='font-bold text-xl pt-2 text-primary'>DR. {suggestedDoctor.name}</h3>
                <h2 className='flex gap-2 text-secondary py-1'>
                  <Stethoscope />
                  <span className='text-[18px] px-2 text-gray-800'>{suggestedDoctor.speciality}</span>
