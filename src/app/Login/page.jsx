        ...
        <div className="flex bg-gray-100 rounded-xl shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl justify-center p-4">
          <div className="w-full p-8 lg:w-1/2">
            ...
            <p className="text-xl text-gray-600 text-center">
              Welcome back to <span className="text-primary font-bold">MEDIX</span>!
            </p>
            {alert.message && (
              <div
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mt-4">
                <div className="flex justify-between">
                  ...
                  <Link
                    href={"http://localhost:3000/Login/Forgetpassword"}
              ...
              <div className="mt-8">
                <button className="bg-secondary text-white font-bold py-2 px-4 w-full rounded hover:bg-primary">
                  Login
                </button>
              </div>
            </form>
            <div className="mt-4 flex items-center justify-between">
              ...
              <Link href={"http://localhost:3000/Signup"} className="text-xs text-gray-500 ">
                {" "}
                New Member? <span className="text-xs text-primary uppercase "> sign up</span>
              </Link>
              <span className="border-b w-1/5 md:w-1/4"></span>
            </div>
          </div>
