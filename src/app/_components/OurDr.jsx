...
export default function OurDr() {
  return (
   ...
   '>
      ...
      {/* <section className=''>
      <div className="max-w-sm mx-auto overflow-hidden bg-white bg-opacity-50 rounded-lg shadow-lg hover:shadow-blue-400">
  <div className="relative">
    <Image className="w-full h-30  object-cover" src="/dr6.jpeg" alt="Profile Image
    " width={300} height={100}/>
  </div>
  <div className="px-6 py-4">
    <div className="text-xl font-semibold text-gray-800">Doctor</div>
...
<div className="flex items-center">
  ...
  <div className="px-6 py-4">
    <Link href="#" className="text-blue-500 hover:underline"><Button>View Profile</Button> </Link>
  </div>
</div>
