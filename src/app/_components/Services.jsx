...
// {/* <section className="pb-12 pt-20 pl-20 pr-20 bg-white lg:pb-[90px] lg:pt-[120px]" id="services">
...
//         <div className='mx-5 gap-9 relative flex  justify-center align-content-center '>
...
//             </span>
//             <h2 className='text-gray-600 group-hover:text-white/90 pt-4 pl-4 text-xl font-bold  '>Hello</h2>
//             <div
...
//                 <p>
//                     <Link href="#" className="secondary transition-all duration-300 text-primary group-hover:text-secondary">Read the docs
//                         &rarr;
//                     </Link>
//                 </p>
//             </div>
...
//                 </svg>
//             </span>
//             <h2 className='text-gray-600 group-hover:text-white/90 pt-4 pl-4 text-xl font-medium  '>Hello</h2>
//             <div
//                 className="space-y-6 pt-5 text-base leading-7 text-gray-600 transition-all duration-300 group-hover:text-white/90">
//                 <p>Perfect for learning how the framework works, prototyping a new idea, or creating a demo to share
//                     online.</p>
